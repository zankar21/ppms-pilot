...
export default function Maintenance() {
  ...
  const submit = async () => {
    const payload = {
      type: form.type, unit: form.unit, department: form.department,
      equipment_tag: form.equipment_tag || "", fault: form.fault || "",
    };
    try {
  ...
  const save = async () => {
    ...
    try {
      const payload = {
        type: edit.type, unit: edit.unit, department: edit.department,
        equipment_tag: edit.equipment_tag || "", fault: edit.fault || "",
        cause: edit.cause || "", remedy: edit.remedy || "", status: edit.status || "Open",
        technician: edit.technician || "", work_order_id: edit.work_order_id || "",
    ...
    <>
      <div className="p-4 md:p-6">
        ...
        <div className="flex items-center gap-2" style={{ marginBottom: 12, flexWrap: "wrap" }}>
          ...
          <button className="btn" onClick={() => exportCsv("maintenance_filtered.csv", rows)}>Export CSV</button>
        </div>
        ...
        <div className="card" style={{ marginTop: 12 }}>
          ...
          <div className="responsive-grid-6"
            style={{ display: "grid", gridTemplateColumns: "repeat(6, minmax(0,1fr))", gap: 10, marginBottom: 12, marginTop: 10 }}>
          ...
          <div className="table-responsive">
            <table className="table">
              <thead>
                <tr><th>When</th><th>Type</th><th>Unit</th><th>Dept</th><th>Equipment</th><th>Fault</th></tr>
              </thead>
              <tbody>
                {rows.map((r) => (
      ...
      {/* Drawer with fixed footer slot; Drawer owns scroll area */}
      <Drawer
        open={open}
