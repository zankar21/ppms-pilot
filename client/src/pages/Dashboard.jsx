...
export default function Dashboard() {
  ...
  const sparkTxns = useMemo(() => bucketPerDay(txns, (r) => r.txn_dt || r.createdAt), [txns]);
  const sparkMaint = useMemo(() => bucketPerDay(maint, (r) => r.createdAt), [maint]);
  const sparkLogs = useMemo(() => bucketPerDay(logs, (r) => r.createdAt), [logs]);
